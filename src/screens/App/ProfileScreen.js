            ...
            <View style={appStyles.container}>
                <View style={styles.profileTopView}>
                    ...
                    <View style={styles.profileButtonView}>
                        <RoundButton tag={0} title={'SETTINGS'} onPress={() => this.props.navigation.navigate('Settings')} />
                        <RoundButton containerStyle={{ marginTop: ASPECT_RATIO(40) }} tag={1} title={'ADD MEDIA'} onPress={() => this.pickMultiple()} />
                        <RoundButton tag={2} title={'EDIT INFO'} onPress={() => this.props.navigation.navigate('EditProfile')} />
                    </View>
                </View>
